...
% ---------------------------------------------
% [A1_matched,A2_matched,B1_matched,B2_matched,Bdiff,samind1,samind2] = matcher(A1,A2,B1,B2)
...
% B2_matched: matched version of B1
% B2_matched: matched version of B2
% samind1: indexes of matching survived elements in A1
% samind2: indexes of matching survived elements in A2

function [A1_matched,A2_matched,B1_matched,B2_matched,samind1,samind2] = matcher3(A1,A2,B1,B2)
...
B1_matched = cell2mat(B1_matched_c);
B2_matched = cell2mat(B2_matched_c);
